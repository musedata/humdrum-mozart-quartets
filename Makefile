## mozart-string-quartets Makefile
##
## Programmer:    Craig Stuart Sapp <craig@ccrma.stanford.edu>
## Creation Date: Wed Jun  4 12:59:31 PDT 2014
## Last Modified: Wed Jun  4 12:59:34 PDT 2014
## Filename:      Makefile
## Syntax:        GNU/BSD makefile
##
## Description:   Makefile for basic processing Humdrum data files 
##                for the quartets of Wolfgang Amadeus Mozart.
##
...
#           git clone https://github.com/musedata/mozart-quartets
#
...
kernscores: humdrum-extras-check
	mkdir -p kernscores; (cd kernscores && humsplit h://mozart/quartets)
	@echo "[0;32m"
...
ifeq ($(shell which curl),)
	...
	for file in kern/*.krn; do \
	   ...
	   curl \
	      "http://kern.humdrum.org/data?l=mozart/quartets&file=$$TBASE.krn&format=pdf" \
...
ifeq ($(wildcard .git),)
	...
	@echo "***    [0;32mgit clone https://github.com/musedata/mozart-quartets[0;31m"
	@echo "[0m"
	exit 1
endif
